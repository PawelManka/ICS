...
typedef struct {
  ...
  real_T Addminx;                      /* '<S22>/Add min x' */
  real_T Addminx_f;                    /* '<S37>/Add min x' */
 ...
 * '<S1>'   : 'rpdriver_with_nn/RP Driver'
 * '<S2>'   : 'rpdriver_with_nn/Stair Generator'
 * '<S3>'   : 'rpdriver_with_nn/dane_1_HL_2  '
 * '<S4>'   : 'rpdriver_with_nn/dane_2_HL_2 '
 * '<S5>'   : 'rpdriver_with_nn/RP Driver/Alfa Normalization'
 * '<S6>'   : 'rpdriver_with_nn/dane_1_HL_2  /Layer 1'
 * '<S7>'   : 'rpdriver_with_nn/dane_1_HL_2  /Layer 2'
 * '<S8>'   : 'rpdriver_with_nn/dane_1_HL_2  /Process Input 1'
 * '<S9>'   : 'rpdriver_with_nn/dane_1_HL_2  /Process Output 1'
 * '<S10>'  : 'rpdriver_with_nn/dane_1_HL_2  /Layer 1/Delays 1'
 * '<S11>'  : 'rpdriver_with_nn/dane_1_HL_2  /Layer 1/IW{1,1}'
 * '<S12>'  : 'rpdriver_with_nn/dane_1_HL_2  /Layer 1/tansig'
 * '<S13>'  : 'rpdriver_with_nn/dane_1_HL_2  /Layer 1/IW{1,1}/dotprod1'
 * '<S14>'  : 'rpdriver_with_nn/dane_1_HL_2  /Layer 1/IW{1,1}/dotprod2'
 * '<S15>'  : 'rpdriver_with_nn/dane_1_HL_2  /Layer 1/IW{1,1}/dotprod3'
 * '<S16>'  : 'rpdriver_with_nn/dane_1_HL_2  /Layer 1/IW{1,1}/dotprod4'
 * '<S17>'  : 'rpdriver_with_nn/dane_1_HL_2  /Layer 2/Delays 1'
 * '<S18>'  : 'rpdriver_with_nn/dane_1_HL_2  /Layer 2/LW{2,1}'
 * '<S19>'  : 'rpdriver_with_nn/dane_1_HL_2  /Layer 2/purelin'
 * '<S20>'  : 'rpdriver_with_nn/dane_1_HL_2  /Layer 2/LW{2,1}/dotprod1'
 * '<S21>'  : 'rpdriver_with_nn/dane_1_HL_2  /Process Input 1/mapminmax'
 * '<S22>'  : 'rpdriver_with_nn/dane_1_HL_2  /Process Output 1/mapminmax_reverse'
 * '<S23>'  : 'rpdriver_with_nn/dane_2_HL_2 /Layer 1'
 * '<S24>'  : 'rpdriver_with_nn/dane_2_HL_2 /Layer 2'
 * '<S25>'  : 'rpdriver_with_nn/dane_2_HL_2 /Process Input 1'
 * '<S26>'  : 'rpdriver_with_nn/dane_2_HL_2 /Process Output 1'
 * '<S27>'  : 'rpdriver_with_nn/dane_2_HL_2 /Layer 1/Delays 1'
 * '<S28>'  : 'rpdriver_with_nn/dane_2_HL_2 /Layer 1/IW{1,1}'
 * '<S29>'  : 'rpdriver_with_nn/dane_2_HL_2 /Layer 1/tansig'
 * '<S30>'  : 'rpdriver_with_nn/dane_2_HL_2 /Layer 1/IW{1,1}/dotprod1'
 * '<S31>'  : 'rpdriver_with_nn/dane_2_HL_2 /Layer 1/IW{1,1}/dotprod2'
 * '<S32>'  : 'rpdriver_with_nn/dane_2_HL_2 /Layer 2/Delays 1'
 * '<S33>'  : 'rpdriver_with_nn/dane_2_HL_2 /Layer 2/LW{2,1}'
 * '<S34>'  : 'rpdriver_with_nn/dane_2_HL_2 /Layer 2/purelin'
 * '<S35>'  : 'rpdriver_with_nn/dane_2_HL_2 /Layer 2/LW{2,1}/dotprod1'
 * '<S36>'  : 'rpdriver_with_nn/dane_2_HL_2 /Process Input 1/mapminmax'
 * '<S37>'  : 'rpdriver_with_nn/dane_2_HL_2 /Process Output 1/mapminmax_reverse'
 */
