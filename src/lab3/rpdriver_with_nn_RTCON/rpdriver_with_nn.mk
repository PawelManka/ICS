...
MODEL                = rpdriver_with_nn
MODULES              = rt_matrx.c rt_printf.c rt_logging.c rpdriver_with_nn_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             = rpdriver_with_nn.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = E:\MATLAB_WORK\ICS_sr_800_lisek_manka\ICS\src\lab3
S_FUNCTIONS          = rtiostream_utils.c rtdacusb2_rpend_dd.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
NCSTATES             = 0
BUILDARGS            =  MAT_FILE=1 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DEXT_MODE -DON_TARGET_WAIT_FOR_START=0"
MULTITASKING         = 0
EXT_MODE             = 1
...
SHARED_LIB           = 
TARGET_LANG_EXT      = c
MEX_OPT_FILE         = -f "C:\Program Files\MATLAB\R2018b\bin\win64\mexopts\msvc2017.xml"
VISUAL_VER           = 15.0
OPTIMIZATION_FLAGS   = 
ADDITIONAL_LDFLAGS   = 
...
MODELLIB                  = rpdriver_with_nnlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = rpdriver_with_nn_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\rpdriver_with_nn_RTCON
MATLAB_INCLUDES = $(MATLAB_INCLUDES);E:\MATLAB_WORK\ICS_sr_800_lisek_manka\ICS\src\lab_2\simulink_script
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\extern\include
