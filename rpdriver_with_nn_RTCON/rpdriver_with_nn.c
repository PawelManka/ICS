...
void rpdriver_with_nn_initialize(void)
{
  ...
  /* External mode info */
  rpdriver_with_nn_M->Sizes.checksums[0] = (535316279U);
  rpdriver_with_nn_M->Sizes.checksums[1] = (220682595U);
  rpdriver_with_nn_M->Sizes.checksums[2] = (1242685692U);
  rpdriver_with_nn_M->Sizes.checksums[3] = (646618512U);
